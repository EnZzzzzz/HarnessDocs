...
const TOC_ITEMS = [
  ...
  { id: 'rsi-what', label: 'RSI 是什么' },
  { id: 'se-what', label: '传统 Agent vs 自进化' },
  { id: 'se-vs-reflection', label: '无感知进化' },
  { id: 'se-scenarios', label: '真实场景举例' },
  { id: 'se-reward-driven', label: '设计师角色转变' },
  { id: 'se-expert-driven', label: 'Harness × 专家知识' },
  { id: 'se-layers', label: '进化的五层' },
  { id: 'se-wikiskill', label: 'WikiSkill 经验维基' },
  { id: 'se-wikiskill-flow', label: 'WikiSkill 总体流程' },
  { id: 'webgrader-problem', label: 'WebGrader 问题' },
  { id: 'webgrader-solution', label: 'WebGrader 方案' },
  { id: 'webgrader-results', label: 'WebGrader 效果' },
  { id: 'eval-dataset', label: '评测集构建' },
